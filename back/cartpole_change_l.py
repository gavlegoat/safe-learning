...
# Last Modified time: 2018-11-14 22:05:42
# -------------------------------
import numpy as np
from main import *
from DDPG import *
...
def cartpole(learning_method, number_of_rollouts, simulation_steps, ddpg_learning_eposides, critic_structure, actor_structure, train_dir):
  ...
  shield.train_shield(learning_method, number_of_rollouts, simulation_steps, names=names, explore_mag = 2, step_size = 2)
