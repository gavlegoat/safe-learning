...
if __name__ == "__main__":
  ...
  cooling("random_search", 100, 100, 0, [240, 200], [280, 240, 200], "ddpg_chkp/cooling/240200280240200/", nn_test=nn_test, retrain_shield=retrain_shield, shield_test=shield_test, test_episodes=test_episodes)