...
def satelite (learning_method, number_of_rollouts, simulation_steps, critic_structure, actor_structure, train_dir,\
...
if __name__ == "__main__":
  ...
  satelite("random_search", 200, 100, [240,200], [280,240,200], \
    "ddpg_chkp/satelite/240200280240200/", nn_test=nn_test, retrain_shield=retrain_shield, \
    shield_test=shield_test, test_episodes=test_episodes, retrain_nn=retrain_nn)